"""
Generate the complete BLUEGUN 2026 js/app.js file.
"""
  ...
  mainContentEl.innerHTML = `
    ...
    <section class="bl-hero-section">
      ...
      <div class="hero-content">
        ...
        <p class="hero-lead">
          Real-time tactical intelligence, algorithmic transfer probability, and 2026 high-ego European scouting analytics.
        </p>
...
/**
 * VIEW: CLUBS WAR ROOMS
 */
function renderClubsListView() {
  mainContentEl.innerHTML = `
    <div class="view-header-strip">
      <div>
        <span class="sub-label">EUROPEAN CLUBS WAR ROOMS</span>
        <h1 class="main-title">TOP 10 EUROPEAN POWERHOUSES (2026)</h1>
      </div>
    </div>
...
function handleGlobalSearchInput() {
  ...
  if (!q) {
    globalSearchResults.innerHTML = `
      <div class="search-hint-box">
        <span>⚡ Quick shortcuts: Type player name (e.g. <em>Wirtz, Mbappé, Haaland, Isak</em>), club (<em>Real Madrid, Arsenal</em>), or status (<em>Confirmed</em>).</span>
      </div>
    `;
    return;
  }
  ...
  if (matchedClubs.length > 0) {
    html += '<div class="search-category-title">WAR ROOMS</div>';
...
with open(r"c:\Users\LENOVO\Desktop\web\js\app.js", "w", encoding="utf-8") as f:
    f.write(bluegun_app_js.strip())

print("Successfully updated js/app.js with BLUEGUN 2026 controller and war room views!")
